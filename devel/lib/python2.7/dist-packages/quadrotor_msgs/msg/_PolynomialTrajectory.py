...
class PolynomialTrajectory(genpy.Message):
  _md5sum = "01f57d193ea3b65cc34db1e26ccaaa7a"
...
"""
  ...
  __slots__ = ['header','trajectory_id','action','num_order','num_segment','start_yaw','final_yaw','coef_x','coef_y','coef_z','time','mag_coeff','order','start_time','local_start_t','occ_state','debug_info']
  _slot_types = ['std_msgs/Header','uint32','uint32','uint32','uint32','float64','float64','float64[]','float64[]','float64[]','float64[]','float64','uint32[]','time','float64','uint32','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,trajectory_id,action,num_order,num_segment,start_yaw,final_yaw,coef_x,coef_y,coef_z,time,mag_coeff,order,start_time,local_start_t,occ_state,debug_info
